 ...
 */
public class ApplyGrouponBillEntity {
    ...
    public static class Reception {
        public static class ReceptionDay {
            ...
            public List<String> validation(boolean needAppoint) {
                ...
                if (CollectionUtils.isEmpty(getSessions())) {
                    ...
                    for (Session session : getSessions()) {
                        if (null == session.getRange() || StringUtils.isBlank(session.getRange().getStart())) {
                            result.add("场次开始日期必填");
                        }
                        if (null == session.getRange() || StringUtils.isBlank(session.getRange().getEnd())) {
                            result.add("场次结束日期必填");
                        }
                    }
                }
